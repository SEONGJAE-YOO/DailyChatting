...
public class Join extends JFrame{  
	...
	Join()
	{
		...
		//데이터베이스의 논리적 작업 단위-insert,update,select,delete(DML 용어)

		sql= "create table if not exists user("
				+"user_id char(15) primary key,"
			    +"user_name varchar(16),"
			    +"user_pw varchar(16)"
			+")engine innoDB DEFAULT CHARSET=utf8;";//트랜잭션 사용가능 하기 위해서 innodb사용
	...
	class JoinAction implements ActionListener{//자바 swing 인터페이스 사용함 
		@Override
			...
			{   
				...
				else
				{
					...
					try {   
						...
						sql = "select user_id from User where user_id ='"+idF.getText()+"';";
						...
						sql = "insert into User(user_id, user_pw, user_name) values ('" 
